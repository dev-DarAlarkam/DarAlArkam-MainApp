...
class _ActivityViewerState extends State<ActivityViewer> {
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            image: DecorationImage(
                                image: NetworkImage(generateDirectDownloadUrl(widget.activity.thumbnail)),
                                fit: BoxFit.fitWidth,
  ...
  String generateDirectDownloadUrl(String originalUrl) {
    ...
    final directDownloadUrl = 'https://drive.google.com/uc?export=download&id=$fileId';
