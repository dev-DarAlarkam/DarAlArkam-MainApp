...
class CounterScreenEdit extends StatefulWidget {
  final Counter counter;

  CounterScreenEdit({required this.counter});

  @override
  _CounterScreenEditState createState() => _CounterScreenEditState();
}

class _CounterScreenEditState extends State<CounterScreenEdit> {
  @override
          ...
          actions: [
            ElevatedButton(
                onPressed: () async {
                  ...
                  final docCounter = docUser.collection('counter').doc(widget.counter.date);
